...
var policies = map[string]Policy{
	...
	"clone_completed":              {Method: "POST", RequiresUUID: true},
	"clone_image_name":             {Method: "POST", RequiresUUID: true},
	"clone_job_duration":           {Method: "POST", RequiresUUID: true},
	"clone_master":                 {Method: "POST", RequiresUUID: true},
	...
	"disk_name":                    {Method: "POST", RequiresUUID: true},
	...
	"erase_completed":              {Method: "POST", RequiresUUID: true},
	"erase_disk_pcnt":              {Method: "POST", RequiresUUID: true},
	"erase_job_duration":           {Method: "POST", RequiresUUID: true},
	"erase_mode":                   {Method: "POST", RequiresUUID: true},
	"ethernet_mac":                 {Method: "POST", RequiresUUID: true},
	"init":                         {Method: "POST", RequiresUUID: true},
	"job_cancelled":                {Method: "POST", RequiresUUID: true},
	"job_start_time":               {Method: "POST", RequiresUUID: true},
