...
curl -o $clientPath https://raw.githubusercontent.com/cameronraschke/uit-client/refs/heads/main/uit-client_2.0-1_amd64/opt/uit-toolbox/windows/uit-toolbox-client.ps1
